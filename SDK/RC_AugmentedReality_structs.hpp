...
{
	unsigned char                                      UnknownData00[0x5AFFAA80];                                // 0x0000(0x5AFFAA80) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x5AFFA880];                                // 0x0000(0x5AFFA880) MISSED OFFSET
};
...
struct FARPose3D
{
	unsigned char                                      UnknownData00[0x5AFFA680];                                // 0x0000(0x5AFFA680) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x5AFFC600];                                // 0x0000(0x5AFFC600) MISSED OFFSET
};
...
struct FARPose2D
{
	unsigned char                                      UnknownData00[0x5AFFC480];                                // 0x0000(0x5AFFC480) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x5AFFC300];                                // 0x0000(0x5AFFC300) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x5AFFC200];                                // 0x0000(0x5AFFC200) MISSED OFFSET
};
